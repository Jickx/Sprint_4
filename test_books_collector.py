...
class TestBooksCollector:
    ...
    def test_get_books_with_specific_genre_includes_books_only_given_genre(self, collector):
        books = [
    ...
    def test_get_books_genre_current_books_genre_dict(self, collector):
        name = 'Гордость и предубеждение и зомби'
        collector.add_new_book(name)
    ...
    def test_get_books_for_children_in_children_list_there_no_adult_books(self, collector):
        books = [
            ('Гордость и предубеждение и зомби', 'Ужасы'),
            ('Что делать, если ваш кот хочет вас убить', 'Ужасы'),
            ('Анна Каренина против вампиров', 'Комедии'),
